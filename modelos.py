...
class resnet(nn.Module):
    def __init__(self, num_classes=8):
        ...
        self.weights = models.ResNet50_Weights.DEFAULT  # or IMAGENET1K_V1 for reproducibility
...
class resnetpcam(nn.Module):
    def __init__(self, num_classes=1):
        super(resnetpcam, self).__init__()
        self.weights = models.ResNet18_Weights.DEFAULT  # or IMAGENET1K_V1 for reproducibility
